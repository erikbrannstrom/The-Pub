...
return null;
    ...
    private void loopvoidTovoid(Op_ext.JRProxyOp retOp, Cap_ext fretOp, edu.ucdavis.jr.RemoteHandler handler, java.lang.Object [] JRargs)
    {
        try    {
            {
                InStatObj JRInstmt1 = new InStatObj(5, false);
                boolean run = true;
                JRLoop2: while (run) {
                    {
                        // Inni Statement without quantifier
                        JRInstmt1.armArray[0] = new QuantRec(new Cap_ext_(op_tick_voidTovoid, "void"), 0, 0);
                        JRInstmt1.armArray[1] = new QuantRec(new Cap_ext_(op_getTime_voidToMyTime, "MyTime"), 1, 1);
                        JRInstmt1.armArray[2] = new QuantRec(new Cap_ext_(op_setAlarm_Cap_voidTovoidXMyTimeTovoid, "void"), 2, 2);
                        JRInstmt1.armArray[3] = new QuantRec(new Cap_ext_(op_setAlarmEndTime_Cap_voidTovoidTovoid, "void"), 3, 3);
                        JRInstmt1.armArray[4] = new QuantRec(new Cap_ext_(op_shutdown_voidTovoid, "void"), 4, 4);
                        JRInstmt1.lock();
                                                ...
                                                try {
                                                    {
                                                        ...
                                                        if (chs != null) JRLoop1: for (Object ch : chs) ((// NUMBER 8
                                                ...
                                                try {
                                                    {
                                                        // Return
                                                        {
                                                            if (true)
                                                                { if (JRrrecv1.retOp != null)
                                                                    JRrrecv1.retOp.send(jrvm.getTimestamp(), (edu.ucdavis.jr.RemoteHandler) null, new java.lang.Object [] {(((MyTime)((MyTime)currentTime.clone())))});
                                                                else {
        ...
        try    {
            {
                ...
                JRLoop3: do {
                    {
                        // Inni Statement without quantifier
                        JRInstmt2.armArray[0] = new QuantRec(new Cap_ext_(op_stopTicker_voidTovoid, "void"), 0, 0);
                        JRInstmt2.lock();
                        // Equivalence Class has been created and locked
